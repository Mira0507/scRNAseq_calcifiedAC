...
my.clusters <- c("EC", "SMC", "ECM", "CTL/NK", "T", "B", "DC/Macrophage")
...
p <- grid.arrange(plotpca.fn(vst, "Batch", x), 
                  plotpca.fn(vst, Condition, x), nrow=2)
...
for (x in my.clusters) {
    ...
    p1 <- ex.heatmap.fn(fdr20.mtx.list[[x]], 
                        TRUE, 
                        annot.list[[x]], 
                        t1)

    p2 <- topgene.plot.fn(fdr20.df.list[[x]], t1) 

    p3 <- ex.heatmap.fn(lfc20.mtx.list[[x]],
                        TRUE, 
                        annot.list[[x]],
                        t2)
    ...
    print(paste("Heatmap:", t1))
    print(p1)
    print(paste("Boxplot:", t1))
    print(p2)
    print(paste("Heatmap:", t2))
    print(p3)
    print(paste("Boxplot:", t2))
    print(p4)
